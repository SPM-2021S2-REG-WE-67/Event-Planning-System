    		...
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
	    				...
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(home/images/home.jpg);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span>VSK Event Planners</span></li>
		            	<li class="d-flex"><span>Since:</span> <span>June 25, 2009</span></li>
		            	<li class="d-flex"><span>Location:</span> <span>Colombo</span></li>
		            	<li class="d-flex"><span>Zip code:</span> <span>00600</span></li>
		            	<li class="d-flex"><span>Email:</span> <span>vskplanners@gmail.com</span></li>
		            	<li class="d-flex"><span>Phone: </span> <span>0112222525</span></li>
		            </ul>
		          </div>
		        </div>
