...
<body>
	...
	<c:forEach var="user" items="${listCaterings}">
...
<div class="flip-card-container" style="--hue: 350">
  <div class="flip-card">
    ...
    <div class="card-front">
      ...
      <ul>
        <li>Catering Name :<c:out value="${user.cateringname}" /></li>
        <li>Catering Menu Details: <c:out value="${user.cateringmenudetails}" /> </li>
    ...
    <div class="card-back">
      ...
      <button onclick="window.location.href='<%=request.getContextPath()%>/newUserCateringBook'" >Book</button>
