...
<%@include file="header.jsp" %>
		<div class="container" style="margin-left: 20%; padding-top:5%">
			<h3 class="text-center">List of Entertainment Services</h3>
			<hr>
			<div class="container text-left">

				<a href="<%=request.getContextPath()%>/newentertainment" class="btn btn-secondary">Add Entertainment Services</a>
			</div>
			...
			<table id="dtBasicExample" class="table table-striped table-bordered table-sm">
				...
				<tbody>
					...
					<c:forEach var="user" items="${listEntertainments}">
						<tr>
						<td><c:out value="${user.resourcename}" /></td>	
							<td><c:out value="${user.typeofentertainment}" /></td>
