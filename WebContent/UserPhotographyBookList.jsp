...
<button onclick="window.location.href='<%=request.getContextPath()%>/listcardphotography'" style="background-color:black;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>

<h1>
	<span class="pink">Photography Resource<span class="white"> <span
...
<table class="container">
	<thead>
		<tr>
			...
			<th><h1>NIC</h1></th>
			<th><h1>Email</h1></th>
			<th><h1>Package Name</h1></th>
			<th><h1>Studio Name</h1></th>
			<th><h1>Booking Date</h1></th>
			<th><h1>Advanced Payment</h1></th>
		</tr>
	</thead>
	<tbody>
		<c:forEach var="user" items="${listPhotographyBooking}">
			...
			<tr>
				...
				<td><c:out value="${user.packagename}" /></td>
