...
<button onclick="window.location.href='<%=request.getContextPath()%>/listcardvenue'" style="background-color:blue;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>

<h1>
	<span class="blue">Venue Resource<span class="blue"> <span
	...
	<tbody>
		<c:forEach var="user" items="${listVenueBooking}">
			...
			<tr>
				...
				<td><c:out value="${user.numberofguests}" /></td>
