...
<button onclick="window.location.href='<%=request.getContextPath()%>/listcardentertainment'" style="background-color:black;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>

<h1>
	<span class="pink">Entertainment<span class="white"> <span
...
<table class="container">
	...
	<tbody>
		<c:forEach var="user" items="${listEntertainmentBooking}">
