...
<button onclick="window.location.href='<%=request.getContextPath()%>/listcardcatering'" style="background-color:black;color:white;padding:10px 20px;" class="btn-primary">Go to Book
</button>
</div>

<h1>
	<span class="pink">Catering Service<span class="pink"> <span
		class="white">Bookings</span>
</h1>
<table class="container">
	<thead>
		<tr>
			...
			<th><h1>NIC</h1></th>
			<th><h1>Email</h1></th>
			<th><h1>No oF Plates</h1></th>
			<th><h1>Additional Needs</h1></th>
			<th><h1>Booking Date</h1></th>
			<th><h1>Advanced Payment</h1></th>
		</tr>
	</thead>
	<tbody>
		<c:forEach var="user" items="${listCateringBooking}">
			...
			<tr>
				...
				<td><c:out value="${user.noofplates}" /></td>
				<td><c:out value="${user.additionalneeds}" /></td>
