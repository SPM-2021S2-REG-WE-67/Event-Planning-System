...
<div class="flip-card-container" style="--hue: 350">
  <div class="flip-card">
    ...
    <div class="card-front">
      ...
      <ul>
        <li>Resource Name :<c:out value="${user.resourcename}" /></li>
        <li>Type of Venue: <c:out value="${user.typeofvenue}" /> Rs</li>
    ...
    <div class="card-back">
      ...
      <button onclick="window.location.href='<%=request.getContextPath()%>/newUserVenueBook'" >Book</button>
