...
<body>
	...
	p.add("Photography Services List");
	...
	Phrase sn = new Phrase("Studio Name", boldFont);
	Phrase available = new Phrase("Available Services", boldFont);
	Phrase location = new Phrase("Location", boldFont);
	Phrase wd = new Phrase("Working Days", boldFont);
	
	table1.addCell(sn);
	table1.addCell(available);
	...
	while (rs.next()) {
		...
		p3.add(rs.getString("studioName"));
		p4.add(rs.getString("availableServices"));
