...
<%@page import="event.dbconnection.DbConnection"%>
...
<body>
	...
	Phrase resourcename = new Phrase("Resource Name", boldFont);
	Phrase typeofvenue = new Phrase("Type Of Venue", boldFont);
	Phrase location = new Phrase("Location", boldFont);
	Phrase workingdays = new Phrase("Working Days", boldFont);
	
	table1.addCell(resourcename);
	table1.addCell(typeofvenue);
	table1.addCell(location);
	table1.addCell(workingdays);
	...
	while (rs.next()) {
		...
		p4.add(rs.getString("TypeOfVenue"));
		p5.add(rs.getString("Location"));
		p6.add(rs.getString("WorkingDays"));
