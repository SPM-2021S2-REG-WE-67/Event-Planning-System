...
<button class="btn btn-primary py-3 px-5" onclick="window.location.href='<%=request.getContextPath()%>/listuserbanq'" >Click</button>
</div>
</a>
</div>
<div class="col-md-4 text-center d-flex ftco-animate">
...
<button class="btn btn-primary py-3 px-5" onclick="window.location.href='<%=request.getContextPath()%>/listuserres'" >Click</button>
</div>
</a>
</div>
<div class="col-md-4 text-center d-flex ftco-animate">
...
<button class="btn btn-primary py-3 px-5" onclick="window.location.href='<%=request.getContextPath()%>/listUserRoomBook'" >Click</button>
</div>
</a>
</div>
...
<button class="btn btn-primary py-3 px-5" onclick="window.location.href='<%=request.getContextPath()%>/listVeichleRoomBook'" >Click</button>
</div>
</a>
</div>
