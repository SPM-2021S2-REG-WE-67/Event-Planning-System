          ...
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-center">
          	<div class="text text-center">
          		<span class="subheading">Hey! We are</span>
		  				<h1>VSK Event Planners</h1>
			  				<h2>We Provide
								  <span
								     class="txt-rotate"
								     data-period="2000"
								     data-rotate='[ "Venue Booking..", "Events Photography Service..", "Catering Service..", "Entertainment Service.." ]'></span>
								</h2>
							</div>
            </div>
          </div>
...
<section>
          ...
          <div class="col-md-6 d-flex">
          	<div class="img" style="background-image: url(home/images/homebg.jpg);"></div>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Colombo</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">0112222525</span></a></li>
