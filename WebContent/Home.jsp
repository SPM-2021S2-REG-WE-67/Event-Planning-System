	...
	<div class="container-fluid">
		...
		<div class="colsm12" id="">
			<ul class="sideNav nav navbar">
				...
				<li><a href="#">Photography<span style="font-size: 16px;"
						class="pull-right showopacity glyphicon glyphicon-th-list"></span></a></li>
				<li><a href="#">Entertainment<span style="font-size: 16px;"
						class="pull-right showopacity glyphicon glyphicon-tags"></span></a></li>
				<li><a href="#">Catering<span style="font-size: 16px;"
						class="pull-right showopacity glyphicon glyphicon-th-list"></span></a></li>
				<li><a href="#">Venue<span style="font-size: 16px;"
						class="pull-right showopacity glyphicon glyphicon-tags"></span></a></li>
			</ul>
		</div>
	</div>
