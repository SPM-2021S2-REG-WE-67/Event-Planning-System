...
<body>
	...
	String query = "select * from photographys";
	Statement stmt = null;
	...
	Phrase stn = new Phrase("Studio Name", boldFont);
	Phrase wd = new Phrase("Working Days", boldFont);
	Phrase as = new Phrase("Available Services", boldFont);
	...
	while (rs.next()) {
		...
		p4.add(rs.getString("workingdays"));
		p5.add(rs.getString("availableservices"));
