	...
	<div class="container" style="margin-left: 20%; padding-top: 5%"
		...
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Type Of Entertainment</label> <input type="text"
						value="<c:out value='${user.typeofentertainment}' />" class="form-control"
						name="typeofentertainment" required="required">
				</fieldset>
