...
<body>
	...
	String query = "select * from caterings";
	Statement stmt = null;
	...
	Phrase cat = new Phrase("Catering Name", boldFont);
	Phrase wd = new Phrase("Working Days", boldFont);
	Phrase cateringmenu = new Phrase("Catering Menu Details", boldFont);
	Phrase loc = new Phrase("Location", boldFont);
	
	
	table1.addCell(cat);
	table1.addCell(wd);
	table1.addCell(cateringmenu);
	table1.addCell(loc);
	...
	while (rs.next()) {
		...
		p5.add(rs.getString("cateringmenudetails"));
