...
@WebServlet("/insertvenue")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
maxFileSize = 1024 * 1024 * 10, // 10MB
maxRequestSize = 1024 * 1024 * 50)
public class VenueAddServlet extends HttpServlet {
...
//	       /images/rooms/img.pngsssss
	   String imgname=name1;
		Venues venue = new Venues(resourcename, typeofvenue, workingdays, location,imgname,imagePath);
		try {
			VenuesDao.insertVenues(venue);
