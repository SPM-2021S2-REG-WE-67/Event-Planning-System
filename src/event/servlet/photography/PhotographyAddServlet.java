...
@WebServlet("/insertphotography")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
maxFileSize = 1024 * 1024 * 10, // 10MB
maxRequestSize = 1024 * 1024 * 50)
public class PhotographyAddServlet extends HttpServlet {
	...
	public static final String UPLOAD_DIR = "images"+File.separator+"venue";
	public static final String UPLOAD_DIR2="images/venue";
...
//	       /images/rooms/img.pngsssss
	   ...
	   Photographys photography = new Photographys(studioname, availableservices, workingdays, location,imgname,imagePath);
		try {
			PhotographysDao.insertPhotographys(photography);
