...
public class PhotographyAddServlet extends HttpServlet {
	...
	public static final String UPLOAD_DIR = "images"+File.separator+"photography";
	public static final String UPLOAD_DIR2="images/photography";
...
//	       /images/rooms/img.pngsssss
	   String imgname=name1;
		Photography photography = new Photography (studioName, availableServices, location,workingdays, imgname,imagePath);
		try {
