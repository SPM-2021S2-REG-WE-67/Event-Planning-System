...
@WebServlet("/insertcatering")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
maxFileSize = 1024 * 1024 * 10, // 10MB
maxRequestSize = 1024 * 1024 * 50)
public class CateringAddServlet extends HttpServlet {
...
//	   String savepath ="D:\\Users\\PC\\eclipse-workspace\\Test2\\WebContent\\CateringImg"+File.separator+fileName;
...
//	       /images/rooms/img.pngsssss
	   String imgname=name1;
		Caterings catering = new Caterings(cateringname, cateringmenudetails, workingdays, location,imgname,imagePath);
		try {
			CateringsDao.insertCaterings(catering);
