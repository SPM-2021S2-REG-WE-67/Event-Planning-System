...
@WebServlet("/insertentertainment")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
maxFileSize = 1024 * 1024 * 10, // 10MB
maxRequestSize = 1024 * 1024 * 50)
public class EntertainmentAddServlet extends HttpServlet {
...
//	       /images/rooms/img.pngsssss
	   String imgname=name1;
		Entertainments entertainment = new Entertainments(resourcename, typeofentertainment, workingdays, location,imgname,imagePath);
		try {
			entertainmentsDao.insertentertainments(entertainment);
