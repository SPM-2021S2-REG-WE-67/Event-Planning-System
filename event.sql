...
INSERT INTO `photography` (`id`, `studioName`, `availableServices`, `Location`, `WorkingDays`, `filename`, `path`) VALUES
(13, 'freeze Studio', 'Wedding,Birthday,Puberty Ceremony', 'Malabe', 'Weekend', 'Photography1.jpg', 'D:\\Users\\PC\\eclipse-workspace\\Test2\\WebContent\\PhotographyImg\\Photography1.jpg'),
(14, 'iClick Studio', 'Any' , 'Kandy','Weekdays', 'Photography2.jpg', 'D:\\Users\\PC\\eclipse-workspace\\Test2\\WebContent\\PhotographyImg\\Photography2.jpg');
...
INSERT INTO `photographybooking` (`id`, `User`, `nic`, `mobile`, `email`, `bookingdate`, `studioname`, `packagename`,`AdvancedPayment`) VALUES
(1, 'Kirujan', '9702839936V', 778954562, 'nkiru@gmail.com', '22-01-2019', 'freeze Studio', 'Wedding', 10000),
(4, 'Janu', '9528439936V,', 778954562, 'wurifimun@mailinator.com', '22-06-2019', 'iClick Studio', 'Wedding', 7500),
(5, 'Kriti', '9992839936V', 778954562, 'pyxe@mailinator.com', '1974-11-28', 'freeze Studio', 'Birthday', 22000),
(6, 'Shaan', '9702333936V', 778954562, 'np@gmail.com', '25-06-2019', 'iClick Studio', 'Birthday', 5000);
...
--
-- Indexes for table `photographybooking`
--
ALTER TABLE `photographybooking`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `photographybooking`
--
ALTER TABLE `photographybooking`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
